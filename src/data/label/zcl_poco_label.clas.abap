CLASS zcl_poco_label DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_poco_label IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    LOOP AT lt_create ASSIGNING FIELD-SYMBOL(<fs_create>).
      TRY.
      ...
      CATCH cx_uuid_error .
      ENDTRY.
      <fs_create>-label_uuid = ev_id.
      INSERT zpoco_d_label_a FROM @<fs_create>.
    ENDLOOP.
