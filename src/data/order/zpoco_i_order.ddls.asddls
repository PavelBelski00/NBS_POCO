...
define root view entity zpoco_i_order
  ...
  association [0..1] to zpoco_i_alert     as _Alert          on  $projection.NvsId         = _Alert.NvsId and
                                                                 $projection.OrderUuid     = _Alert.AlertUuid        
  association [0..1] to zpoco_i_alert_wi  as _AlertWi        on  $projection.NvsId         = _AlertWi.NvsId and
                                                                 $projection.OrderUuid     = _AlertWi.AlertWorkItemUuid 
{
